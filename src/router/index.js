...
const pcCourseManage = r => require.ensure([], () => r(require('../components/personalCenter/pcCourseManage')), 'pcCourseManage');//个人中心-专业资源-课程管理
...
const myRouter =new Router({
  ...
  routes: [
    ...
    {path: '/pcCourseManage',name: 'pcCourseManage',component: pcCourseManage,meta: { requiresAuth: pcCourseManage }},//个人中心-专业资源-目录管理
