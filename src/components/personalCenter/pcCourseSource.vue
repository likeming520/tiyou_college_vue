              ...
              <template slot-scope="scope">
                ...
                <el-popover
                  ...
                  <div style="width: 98px;height: 240px;border: 0px solid red;">
                    ...
                    <div class="tisi_pccs_col" @click="CourseManage(scope.row.id)">题库管理</div>
...
export default {
  ...
  data () {
    return {
      ...
      sourceMenuIndex:"1",//资源类型标签  1、2、3
      sourceType:2,//2 、3 、4
...
// console.log("value:",value,"===",this.classChecked)
    ...
    CourseManage(sourceId){
      const pcCourseManage = this.$router.resolve({path: '/pcCourseManage', query: {skillResourcesId: sourceId}});
      window.open(pcCourseManage.href,'_blank');
    },
