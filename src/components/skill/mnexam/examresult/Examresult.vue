<template>
  <div class="examdo" style="position: relative;">
    ...
    <div class="examdo_right">
      ...
      <div>
        <div class="tm" v-for="(items,index) in questionList">
          ...
          <div class="tm_choose choo15" v-for="(itemso,index) in items.options" :class="(ifclass(items.myAnswer ,itemso.questionOption,items.answer) != 0) ?'bgchoosed':''">
